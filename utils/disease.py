# The dataset covers 12 different crop types 
# (Apple, Blueberry, Cherry, Corn/maize, Grape, Orange, Peach, Pepper,
#  Potato, Raspberry, Soybean, Strawberry, Squash, and Tomato) 
# with both healthy samples and various disease conditions.
